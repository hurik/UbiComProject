	...
	public void onCreate() {
		...
		timer.scheduleAtFixedRate(new TimerTask() {
			...
			public void run() {
				...
				/*
				 * if (mFtpServer == null) { Log.e(TAG, "mFtpServer = null");
				 * return; }
				 * 
				 * Log.d(TAG, "mFtpServer.read()"); List<UbiCom_Pos> list =
				 * mFtpServer.read();
				 * 
				 * if (list != null) for (UbiCom_Pos l : list) { Intent i = new
				 * Intent(BROADCAST_ACTION); i.putExtra(BROADCAST_LATITUDE,
				 * l.Latitude); i.putExtra(BROADCAST_LONGITUDE, l.Longtitude);
